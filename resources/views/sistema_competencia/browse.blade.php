...
@section('title', 'Sistema de competencia')
...
@section('content')
                        ...
                        <div class="row g-0 align-items-center">
                            <div class="col-md-8 px-3 py-3">
                                <h1 class="h3 mb-0 text-dark">
                                    <i class="fa-solid fa-sitemap"></i> Sistema de competencia
                                </h1>
                            </div>
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="modalCreateLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('sistema-competencia.store') }}">
                @csrf
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title fw-bold" id="modalCreateLabel">Crear sistema de competencia</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" class="form-control @if(!old('editing_sistema_competencia')) @error('nombre') is-invalid @enderror @endif" maxlength="255" required>
                                @if (!old('editing_sistema_competencia'))
                                    @error('nombre')
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="estado" id="estado" class="form-select @if(!old('editing_sistema_competencia')) @error('estado') is-invalid @enderror @endif" required>
            ...
            <form id="delete_form" method="POST" action="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        Esta seguro de eliminar este sistema de competencia?
                    </div>
...
@push('scripts')
    <script>
        ...
        function list(page = 1) {
            ...
            let url = '{{ route("sistema-competencia.ajax.list") }}';
